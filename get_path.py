...
print("哪里",os.path.realpath(__file__))
print("零零落落",os.path.dirname(os.path.realpath(__file__)))
print("落落",os.path.dirname(os.path.dirname(os.path.realpath(__file__))))

print("\n这里", proj_root_path)
vocab_file_path = os.path.join(proj_root_path, "tokenization/clue-vocab.txt")
print("这里", vocab_file_path)